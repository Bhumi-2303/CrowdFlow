...
export default function HomePage() {
  ...
  // ── Load persisted theme and check auth ───────────────────────
  useEffect(() => {
        ...
        <div className="max-w-4xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`text-xs font-medium px-3 py-1.5 rounded-lg transition-colors border ${isDark ? "border-slate-700 text-slate-300 hover:bg-slate-800" : "border-slate-300 text-slate-600 hover:bg-slate-100"}`}
            >
              Logout
            </button>
          </div>
